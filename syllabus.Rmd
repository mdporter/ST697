...
### Course Assessment:
The course grade will be based on several homework assignments (50%) and a final project (50%). 
...
<!--
The homework solutions must be submitted in pdf format. PhD students must use latex, while other students are strongly encouraged. My recommendation is to use [RMarkdown](http://www.stat.cmu.edu/~cshalizi/rmarkdown/) to produce the pdf. 
Overleaf. 
-->
